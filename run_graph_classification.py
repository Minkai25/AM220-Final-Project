...
hyperparams = {
    "mutag": attridict({"output_dim": 2}),
    "enzymes": attridict({"output_dim": 6}),
    "proteins": attridict({"output_dim": 2}),
    "collab": attridict({"output_dim": 3}),
    "imdb": attridict({"output_dim": 2}),
    "reddit": attridict({"output_dim": 2})
}
